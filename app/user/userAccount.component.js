...
var UserAccountComponent = (function () {
    function UserAccountComponent(_router, _userService) {
        this.pass = false;
        this.account = false;
        this.user = {};
        this.token = {};
    ...
    UserAccountComponent.prototype.onNgInit = function () {
        if (localStorage.getItem("currentUser")) {
            this.token = localStorage.getItem("currentUser");
        }
    };
    UserAccountComponent.prototype.changePass = function () {
        this.pass = !this.pass;
    };
    UserAccountComponent.prototype.changeAccount = function () { this.account = !this.account; };
    UserAccountComponent.prototype.updateProfile = function () {
    };
